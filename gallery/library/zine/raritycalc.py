...
input_file = "NFTZine.io-Master_Metadata_Proof.txt"
...
for i in collection.items:
    for c, t in i.traits.items():
        ...
        if t == "1x1":
            i.rarity_score_normed = i.rarity_score_normed + collection.categories[c].trait_rarity_normed[t]*100
        else:
...
workbook = xlsxwriter.Workbook('../NFTZine.xlsx')
