...
input_file = "GoodboiSociety.io_Master_Metadata_Proof.json"
...
for c in collection.categories.values():
    for t in c.traits:
        ...
        c.trait_rarity_normed[t] = c.trait_rarity[t]*(collection.get_avg_trait_per_cat()/(3.3*len(c.traits)))
...
workbook = xlsxwriter.Workbook('goodboirarity.xlsx')
